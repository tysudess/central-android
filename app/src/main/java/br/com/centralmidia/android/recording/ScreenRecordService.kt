...
class ScreenRecordService : Service() {
    ...
    private fun startRecording(intent: Intent) {
        ...
        startForeground(
            991,
            NotificationCompat.Builder(this, NotificationHelper.CHANNEL_RECORDING)
                .setSmallIcon(R.drawable.ic_stat_central)
                .setContentTitle("Central • Gravando tela")
                .setContentText("Use Pausar ou Parar no aplicativo.")
                .setOngoing(true)
                .build(),
        )
        ...
        val withMic = intent.getBooleanExtra("mic", false)
        val fps = intent.getIntExtra("fps", 30).coerceIn(15, 60)
        val quality = intent.getStringExtra("quality").orEmpty().ifBlank { "original" }
        ...
        val values = ContentValues().apply {
            put(
                ...
                "Central-Gravacao-" + System.currentTimeMillis() + ".mp4",
            )
